  ...
  return (
    <div style={{position:'absolute',inset:0,display:'flex',flexDirection:'column',fontFamily:fam}}>
      ...
      <div className="scr" style={{position:'relative',padding:'0 20px 20px'}}>
        ...
        <button className="btn rip" onClick={submit} disabled={loading} style={{width:'100%',padding:16,fontSize:15,marginBottom:4}}>{loading?'Submitting...':'🥛 Subscribe Now — ₹'+total}</button>
      </div>
    </div>
  );
}
